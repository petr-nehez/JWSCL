...
\Description                                                        Value
------------------------------------------------------------------  ------------
Last known date the file has changed in the repository              \$Date: 2010-09-21 21:05:36 +0000 (Tue, 21 Sep 2010) $
Last known revision number the file has changed in the repository   \$Revision: 1017 $
Last known author who changed the file in the repository.           \$Author: dezipaitor $
Full URL to the latest version of the file in the repository.       \$HeadURL: file:///svn/p/jedi-apilib/code/jwscl/trunk/source/JwsclCertificates.pas $
</table>
}
