...
Full URL to the latest version of the file in the repository.       \$HeadURL: file:///svn/p/jedi-apilib/code/jwscl/trunk/source/JwsclComSecurity.pas $
</table>
}
...
{$ENDIF DEBUG}
  ...
  {This method is a callback method used by property TJwServerAccessControl.OnIsAccessAllowed
   ...
   @param Trustee Not used. Always nil. You can generate it by TJwSecurityID from the Trustee parameter
      ...
      try
        ...
        begin
          ...
          OnIsAccessAllowed(
            ...
            nil, {Not used because can be generated by TJWSecurityID from Trustee parameter} //const Trustee : PTrusteeW;
...
//This method catches EOleSysErrors in the end of the body and instead returns the error value
